...
public class CobolHpTandemParser implements CobolParser {
    ...
    private final CobolPreprocessor.CobolSourceFormatEnum sourceFormat = CobolPreprocessor.CobolSourceFormatEnum.TANDEM;
