...
public interface Cobol extends Tree {
    ...
    class ConditionNameReference implements Cobol {
        ...
        @Nullable
        List<Cobol> references;

        @Nullable
        List<Cobol> inMnemonics;
    ...
    class DataValueInterval implements Cobol {
        ...
        @Nullable
        DataValueIntervalTo to;

        @Override
        public <P> Cobol acceptCobol(CobolVisitor<P> v, P p) {
            return v.visitDataValueInterval(this, p);
        }
    }
    ...
    class DataValueIntervalTo implements Cobol {
        ...
        @Override
        public <P> Cobol acceptCobol(CobolVisitor<P> v, P p) {
            return v.visitDataValueIntervalTo(this, p);
        }
    }
    ...
    class Evaluate implements Statement {
        ...
        @Nullable
        List<Cobol> alsoSelect;

        @Nullable
        List<Cobol> whenPhrase;
    ...
    class FigurativeConstant implements Literal {
        ...
        @Override
        public <P> Cobol acceptCobol(CobolVisitor<P> v, P p) {
            return v.visitFigurativeConstant(this, p);
        }
    }
    ...
    class FileSection implements DataDivisionSection {
        ...
        List<Word> words;
        Word dot;
        List<Cobol> fileDescriptionEntry;
    ...
    class InitializeReplacingPhrase implements Cobol {
        ...
        Markers markers;
        Word replacing;
        List<Cobol> initializeReplacingBy;
    ...
    class ProcedureDeclaratives implements Cobol {
        ...
        Word declaratives;
        Word dot;
        List<Cobol> procedureDeclarative;
    ...
    class ProcedureDivisionByReferencePhrase implements Cobol {
        ...
        List<Cobol> procedureDivisionByReference;
    ...
    class SubtractFromGivingStatement implements Cobol {
        ...
        Space prefix;
        Markers markers;
        List<Cobol> subtractSubtrahend;
        Word from;
        Name subtractMinuendGiving;
        Word giving;
        List<Cobol> subtractGiving;
    ...
    class UnstringSendingPhrase implements Cobol {
        ...
        @Nullable
        List<Cobol> unstringOrAllPhrases;
