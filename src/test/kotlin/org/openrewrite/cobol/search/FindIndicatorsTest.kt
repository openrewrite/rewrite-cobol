    ...
    fun sm206a() = rewriteRun(
        cobolCopy(getNistSource("SM206A.CBL"),
            ...
            spec.afterRecipe { cu ->
                ...
                val printer = CobolPrinter<ExecutionContext>(true, true, true)
                ...
                Assertions.assertThat(result).isEqualTo(
                    """
                        ...
                        000500                   WRK-DS-05V00-O005-001                               KP0024.2
                        000600                                   IN                       KP0024.2
    ...
    fun sm106A() = rewriteRun(
        ...
        { spec ->
            spec.afterRecipe { cu ->
                // Print the POST processed AST to assert that COPIED source is marked.
                val outputCapture = PrintOutputCapture<ExecutionContext>(InMemoryExecutionContext())
                val printer = CobolPrinter<ExecutionContext>(true, true, false)
                printer.visit(cu, outputCapture)
                val result = outputCapture.getOut().trimIndent()
                Assertions.assertThat(result).isEqualTo(
                    """
