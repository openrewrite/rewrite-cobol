...
class FindIndicatorsTest : CobolTest() {
    ...
    companion object {
        val printer = CobolPrinter<ExecutionContext>(false, true)
    }

    override fun defaults(spec: RecipeSpec) {
        spec.recipe(FindIndicators(listOf("D", "Y", "S", "d")))
    }
    ...
    fun db101A() = rewriteRun(
        cobol(getNistSource("DB101A.CBL"),
            """
                ...
                027200~~~>S<~~~    EXIT PROGRAM.                                                DB1014.2
                027300~~~>S<~~~TERMINATE-CALL.                                                  DB1014.2
                ...
                033500~~~>Y<~~~    IF RECORD-COUNT GREATER 50                                   DB1014.2
                033600~~~>Y<~~~        MOVE DUMMY-RECORD TO DUMMY-HOLD                          DB1014.2
                033700~~~>Y<~~~        MOVE SPACE TO DUMMY-RECORD                               DB1014.2
                033800~~~>Y<~~~        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  DB1014.2
                033900~~~>Y<~~~        MOVE CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN             DB1014.2
                034000~~~>Y<~~~        MOVE CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES     DB1014.2
                034100~~~>Y<~~~        MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN          DB1014.2
                034200~~~>Y<~~~        MOVE DUMMY-HOLD TO DUMMY-RECORD                          DB1014.2
                034300~~~>Y<~~~        MOVE ZERO TO RECORD-COUNT.                               DB1014.2
                ...
                075900~~~>D<~~~    PERFORM PASS  SUBTRACT 1 FROM ERROR-COUNTER.                 DB1014.2
                ...
                076900~~~>D<~~~    PERFORM PASS.                                                DB1014.2
                077000~~~>D<~~~    SUBTRACT 1 FROM ERROR-COUNTER.                               DB1014.2
                ...
                078000~~~>D<~~~        PASS.  GO TO DEBUG-LINE-WRITE-03.                        DB1014.2
                078100~~~>D<~~~DEBUG-LINE-TEST-03-A.    PERFORM                                 DB1014.2
                ...
                080900~~~>D<~~~    PERFORM PASS.                                                DB1014.2
                081000~~~>D<~~~    GO TO DEBUG-LINE-WRITE-05.                                   DB1014.2
    ...
    fun sm106A() = rewriteRun(
        cobolCopy(getNistSource("SM106A.CBL"),
            // A marker is added to the COPIED source.
            getNistSource("SM106A.CBL"))
        { spec ->
            spec.afterRecipe { cu ->
                ...
                Assertions.assertThat(result).isEqualTo(
                    """
                        ...
                        016800~~~>S<~~~    EXIT PROGRAM.                                                K6SCA4.2
                        016900~~~>S<~~~TERMINATE-CALL.                                                  K6SCA4.2
                        ...
                        023200~~~>Y<~~~    IF RECORD-COUNT GREATER 42                                   K6SCA4.2
                        023300~~~>Y<~~~        MOVE DUMMY-RECORD TO DUMMY-HOLD                          K6SCA4.2
                        023400~~~>Y<~~~        MOVE SPACE TO DUMMY-RECORD                               K6SCA4.2
                        023500~~~>Y<~~~        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  K6SCA4.2
                        023600~~~>Y<~~~        MOVE CCVS-H-1  TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    K6SCA4.2
                        023700~~~>Y<~~~        MOVE CCVS-H-2A TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    K6SCA4.2
                        023800~~~>Y<~~~        MOVE CCVS-H-2B TO DUMMY-RECORD PERFORM WRT-LN 3 TIMES    K6SCA4.2
                        023900~~~>Y<~~~        MOVE CCVS-H-3  TO DUMMY-RECORD PERFORM WRT-LN 3 TIMES    K6SCA4.2
                        024000~~~>Y<~~~        MOVE CCVS-C-1  TO DUMMY-RECORD PERFORM WRT-LN            K6SCA4.2
                        024100~~~>Y<~~~        MOVE CCVS-C-2  TO DUMMY-RECORD PERFORM WRT-LN            K6SCA4.2
                        024200~~~>Y<~~~        MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN          K6SCA4.2
                        024300~~~>Y<~~~        MOVE DUMMY-HOLD TO DUMMY-RECORD                          K6SCA4.2
                        024400~~~>Y<~~~        MOVE ZERO TO RECORD-COUNT.                               K6SCA4.2
