...
004000P    SELECT RAW-DATA   ASSIGN TO                                  SQ2204.2
004100P    XXXXX062                                                     SQ2204.2
004200P           ORGANIZATION IS INDEXED                               SQ2204.2
004300P           ACCESS MODE IS RANDOM                                 SQ2204.2
004400P           RECORD KEY IS RAW-DATA-KEY.                           SQ2204.2
...
005300P                                                                 SQ2204.2
005400PFD  RAW-DATA.                                                    SQ2204.2
005500P                                                                 SQ2204.2
005600P01  RAW-DATA-SATZ.                                               SQ2204.2
005700P    05  RAW-DATA-KEY        PIC X(6).                            SQ2204.2
005800P    05  C-DATE              PIC 9(6).                            SQ2204.2
005900P    05  C-TIME              PIC 9(8).                            SQ2204.2
006000P    05  C-NO-OF-TESTS       PIC 99.                              SQ2204.2
006100P    05  C-OK                PIC 999.                             SQ2204.2
006200P    05  C-ALL               PIC 999.                             SQ2204.2
006300P    05  C-FAIL              PIC 999.                             SQ2204.2
006400P    05  C-DELETED           PIC 999.                             SQ2204.2
006500P    05  C-INSPECT           PIC 999.                             SQ2204.2
006600P    05  C-NOTE              PIC X(13).                           SQ2204.2
006700P    05  C-INDENT            PIC X.                               SQ2204.2
006800P    05  C-ABORT             PIC X(8).                            SQ2204.2
006900 FD  PRINT-FILE                                                   SQ2204.2
007000C    LABEL RECORDS                                                SQ2204.2
007100C    XXXXX084                                                     SQ2204.2
007200C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2204.2
007300               .                                                  SQ2204.2
007400 01  PRINT-REC PICTURE X(120).                                    SQ2204.2
007500 01  DUMMY-RECORD PICTURE X(120).                                 SQ2204.2
007600 FD  SQ-VS7                                                       SQ2204.2
007700C    LABEL RECORDS ARE STANDARD                                   SQ2204.2
...
027400P    OPEN I-O RAW-DATA.                                           SQ2204.2
027500P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2204.2
027600P    READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2204.2
027700P    MOVE "ABORTED " TO C-ABORT.                                  SQ2204.2
027800P    ADD 1 TO C-NO-OF-TESTS.                                      SQ2204.2
027900P    ACCEPT C-DATE  FROM DATE.                                    SQ2204.2
028000P    ACCEPT C-TIME  FROM TIME.                                    SQ2204.2
028100P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2204.2
028200PEND-E-1.                                                         SQ2204.2
028300P    CLOSE RAW-DATA.                                              SQ2204.2
...
029800P    OPEN I-O RAW-DATA.                                           SQ2204.2
029900P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2204.2
030000P    READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2204.2
030100P    MOVE "OK.     " TO C-ABORT.                                  SQ2204.2
030200P    MOVE PASS-COUNTER TO C-OK.                                   SQ2204.2
030300P    MOVE ERROR-HOLD   TO C-ALL.                                  SQ2204.2
030400P    MOVE ERROR-COUNTER TO C-FAIL.                                SQ2204.2
030500P    MOVE DELETE-CNT TO C-DELETED.                                SQ2204.2
030600P    MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2204.2
030700P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2204.2
030800PEND-E-2.                                                         SQ2204.2
030900P    CLOSE RAW-DATA.                                              SQ2204.2
031000 TERMINATE-CCVS.                                                  SQ2204.2
031100S    EXIT PROGRAM.                                                SQ2204.2
031200STERMINATE-CALL.                                                  SQ2204.2
...
037400Y    IF RECORD-COUNT GREATER 50                                   SQ2204.2
037500Y        MOVE DUMMY-RECORD TO DUMMY-HOLD                          SQ2204.2
037600Y        MOVE SPACE TO DUMMY-RECORD                               SQ2204.2
037700Y        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  SQ2204.2
037800Y        MOVE CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN             SQ2204.2
037900Y        MOVE CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES     SQ2204.2
038000Y        MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN          SQ2204.2
038100Y        MOVE DUMMY-HOLD TO DUMMY-RECORD                          SQ2204.2
038200Y        MOVE ZERO TO RECORD-COUNT.                               SQ2204.2
