...
003700P    SELECT RAW-DATA   ASSIGN TO                                  SQ1084.2
003800P    XXXXX062                                                     SQ1084.2
003900P           ORGANIZATION IS INDEXED                               SQ1084.2
004000P           ACCESS MODE IS RANDOM                                 SQ1084.2
004100P           RECORD KEY IS RAW-DATA-KEY.                           SQ1084.2
...
005000P                                                                 SQ1084.2
005100PFD  RAW-DATA.                                                    SQ1084.2
005200P                                                                 SQ1084.2
005300P01  RAW-DATA-SATZ.                                               SQ1084.2
005400P    05  RAW-DATA-KEY        PIC X(6).                            SQ1084.2
005500P    05  C-DATE              PIC 9(6).                            SQ1084.2
005600P    05  C-TIME              PIC 9(8).                            SQ1084.2
005700P    05  C-NO-OF-TESTS       PIC 99.                              SQ1084.2
005800P    05  C-OK                PIC 999.                             SQ1084.2
005900P    05  C-ALL               PIC 999.                             SQ1084.2
006000P    05  C-FAIL              PIC 999.                             SQ1084.2
006100P    05  C-DELETED           PIC 999.                             SQ1084.2
006200P    05  C-INSPECT           PIC 999.                             SQ1084.2
006300P    05  C-NOTE              PIC X(13).                           SQ1084.2
006400P    05  C-INDENT            PIC X.                               SQ1084.2
006500P    05  C-ABORT             PIC X(8).                            SQ1084.2
006600 FD  PRINT-FILE                                                   SQ1084.2
006700C    LABEL RECORDS                                                SQ1084.2
006800C    XXXXX084                                                     SQ1084.2
006900C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1084.2
007000               .                                                  SQ1084.2
007100 01  PRINT-REC PICTURE X(120).                                    SQ1084.2
007200 01  DUMMY-RECORD PICTURE X(120).                                 SQ1084.2
007300 FD  SQ-FS8                                                       SQ1084.2
007400C    LABEL RECORD STANDARD                                        SQ1084.2
...
027500P    OPEN I-O RAW-DATA.                                           SQ1084.2
027600P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1084.2
027700P    READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1084.2
027800P    MOVE "ABORTED " TO C-ABORT.                                  SQ1084.2
027900P    ADD 1 TO C-NO-OF-TESTS.                                      SQ1084.2
028000P    ACCEPT C-DATE  FROM DATE.                                    SQ1084.2
028100P    ACCEPT C-TIME  FROM TIME.                                    SQ1084.2
028200P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1084.2
028300PEND-E-1.                                                         SQ1084.2
028400P    CLOSE RAW-DATA.                                              SQ1084.2
...
029900P    OPEN I-O RAW-DATA.                                           SQ1084.2
030000P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1084.2
030100P    READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1084.2
030200P    MOVE "OK.     " TO C-ABORT.                                  SQ1084.2
030300P    MOVE PASS-COUNTER TO C-OK.                                   SQ1084.2
030400P    MOVE ERROR-HOLD   TO C-ALL.                                  SQ1084.2
030500P    MOVE ERROR-COUNTER TO C-FAIL.                                SQ1084.2
030600P    MOVE DELETE-CNT TO C-DELETED.                                SQ1084.2
030700P    MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1084.2
030800P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1084.2
030900PEND-E-2.                                                         SQ1084.2
031000P    CLOSE RAW-DATA.                                              SQ1084.2
031100 TERMINATE-CCVS.                                                  SQ1084.2
031200S    EXIT PROGRAM.                                                SQ1084.2
031300STERMINATE-CALL.                                                  SQ1084.2
...
037500Y    IF RECORD-COUNT GREATER 50                                   SQ1084.2
037600Y        MOVE DUMMY-RECORD TO DUMMY-HOLD                          SQ1084.2
037700Y        MOVE SPACE TO DUMMY-RECORD                               SQ1084.2
037800Y        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  SQ1084.2
037900Y        MOVE CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN             SQ1084.2
038000Y        MOVE CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES     SQ1084.2
038100Y        MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN          SQ1084.2
038200Y        MOVE DUMMY-HOLD TO DUMMY-RECORD                          SQ1084.2
038300Y        MOVE ZERO TO RECORD-COUNT.                               SQ1084.2
