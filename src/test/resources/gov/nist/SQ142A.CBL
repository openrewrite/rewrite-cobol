...
003700     XXXXX082.                                                    SQ1424.2
003800 OBJECT-COMPUTER.                                                 SQ1424.2
003900     XXXXX083.                                                    SQ1424.2
004000*                                                                 SQ1424.2
004100 INPUT-OUTPUT SECTION.                                            SQ1424.2
004200 FILE-CONTROL.                                                    SQ1424.2
004300     SELECT PRINT-FILE ASSIGN TO                                  SQ1424.2
004400     XXXXX055.                                                    SQ1424.2
004500*                                                                 SQ1424.2
004600P    SELECT RAW-DATA   ASSIGN TO                                  SQ1424.2
004700P    XXXXX062                                                     SQ1424.2
004800P          ORGANIZATION IS INDEXED                                SQ1424.2
004900P          ACCESS MODE  IS RANDOM                                 SQ1424.2
005000P          RECORD-KEY   IS RAW-DATA-KEY.                          SQ1424.2
005100P                                                                 SQ1424.2
...
006000C    LABEL RECORDS                                                SQ1424.2
006100C    XXXXX084                                                     SQ1424.2
006200C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1424.2
006300               .                                                  SQ1424.2
006400 01  PRINT-REC    PICTURE X(120).                                 SQ1424.2
006500 01  DUMMY-RECORD PICTURE X(120).                                 SQ1424.2
006600P                                                                 SQ1424.2
006700PFD  RAW-DATA.                                                    SQ1424.2
006800P01  RAW-DATA-SATZ.                                               SQ1424.2
006900P    05  RAW-DATA-KEY        PIC X(6).                            SQ1424.2
007000P    05  C-DATE              PIC 9(6).                            SQ1424.2
007100P    05  C-TIME              PIC 9(8).                            SQ1424.2
007200P    05  NO-OF-TESTS         PIC 99.                              SQ1424.2
007300P    05  C-OK                PIC 999.                             SQ1424.2
007400P    05  C-ALL               PIC 999.                             SQ1424.2
007500P    05  C-FAIL              PIC 999.                             SQ1424.2
007600P    05  C-DELETED           PIC 999.                             SQ1424.2
007700P    05  C-INSPECT           PIC 999.                             SQ1424.2
007800P    05  C-NOTE              PIC X(13).                           SQ1424.2
007900P    05  C-INDENT            PIC X.                               SQ1424.2
008000P    05  C-ABORT             PIC X(8).                            SQ1424.2
008100*                                                                 SQ1424.2
008200 FD  SQ-FS1                                                       SQ1424.2
008300C    LABEL RECORD IS STANDARD                                     SQ1424.2
008400                .                                                 SQ1424.2
...
035800Y    IF RECORD-COUNT GREATER 50                                   SQ1424.2
035900Y        MOVE    DUMMY-RECORD TO DUMMY-HOLD                       SQ1424.2
036000Y        MOVE    SPACE TO DUMMY-RECORD                            SQ1424.2
036100Y        WRITE   DUMMY-RECORD AFTER ADVANCING PAGE                SQ1424.2
036200Y        MOVE    CCVS-C-1 TO DUMMY-RECORD PERFORM DECL-WRT-LN     SQ1424.2
036300Y        MOVE    CCVS-C-2 TO DUMMY-RECORD                         SQ1424.2
036400Y        PERFORM DECL-WRT-LN 2 TIMES                              SQ1424.2
036500Y        MOVE    HYPHEN-LINE TO DUMMY-RECORD                      SQ1424.2
036600Y        PERFORM DECL-WRT-LN                                      SQ1424.2
036700Y        MOVE    DUMMY-HOLD TO DUMMY-RECORD                       SQ1424.2
036800Y        MOVE    ZERO TO RECORD-COUNT.                            SQ1424.2
...
041200P    OPEN    I-O RAW-DATA.                                        SQ1424.2
041300P    MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1424.2
041400P    READ    RAW-DATA INVALID KEY GO TO END-E-1.                  SQ1424.2
041500P    MOVE   "ABORTED "   TO C-ABORT.                              SQ1424.2
041600P    ADD     1           TO C-NO-OF-TESTS.                        SQ1424.2
041700P    ACCEPT  C-DATE      FROM DATE.                               SQ1424.2
041800P    ACCEPT  C-TIME      FROM TIME.                               SQ1424.2
041900P    REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1424.2
042000PEND-E-1.                                                         SQ1424.2
042100P    CLOSE   RAW-DATA.                                            SQ1424.2
...
043900P    OPEN    I-O RAW-DATA.                                        SQ1424.2
044000P    MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1424.2
044100P    READ    RAW-DATA INVALID KEY GO TO END-E-2.                  SQ1424.2
044200P    MOVE   "OK.     " TO C-ABORT.                                SQ1424.2
044300P    MOVE    PASS-COUNTER  TO C-OK.                               SQ1424.2
044400P    MOVE    ERROR-HOLD    TO C-ALL.                              SQ1424.2
044500P    MOVE    ERROR-COUNTER TO C-FAIL.                             SQ1424.2
044600P    MOVE    DELETE-CNT    TO C-DELETED.                          SQ1424.2
044700P    MOVE    INSPECT-COUNTER TO C-INSPECT.                        SQ1424.2
044800P    REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1424.2
044900PEND-E-2.                                                         SQ1424.2
045000P    CLOSE   RAW-DATA.                                            SQ1424.2
045100 TERMINATE-CCVS.                                                  SQ1424.2
045200S    EXIT    PROGRAM.                                             SQ1424.2
...
054400Y    IF RECORD-COUNT GREATER 50                                   SQ1424.2
054500Y        MOVE  DUMMY-RECORD TO DUMMY-HOLD                         SQ1424.2
054600Y        MOVE  SPACE TO DUMMY-RECORD                              SQ1424.2
054700Y        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  SQ1424.2
054800Y        MOVE  CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN            SQ1424.2
054900Y        MOVE  CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    SQ1424.2
055000Y        MOVE  HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN         SQ1424.2
055100Y        MOVE  DUMMY-HOLD TO DUMMY-RECORD                         SQ1424.2
055200Y        MOVE  ZERO TO RECORD-COUNT.                              SQ1424.2
