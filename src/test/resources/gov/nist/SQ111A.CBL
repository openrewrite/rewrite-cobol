...
004300P    SELECT RAW-DATA   ASSIGN TO                                  SQ1114.2
004400P    XXXXX062                                                     SQ1114.2
004500P           ORGANIZATION IS INDEXED                               SQ1114.2
004600P           ACCESS MODE IS RANDOM                                 SQ1114.2
004700P           RECORD KEY IS RAW-DATA-KEY.                           SQ1114.2
...
005500P                                                                 SQ1114.2
005600PFD  RAW-DATA.                                                    SQ1114.2
005700P                                                                 SQ1114.2
005800P01  RAW-DATA-SATZ.                                               SQ1114.2
005900P    05  RAW-DATA-KEY        PIC X(6).                            SQ1114.2
006000P    05  C-DATE              PIC 9(6).                            SQ1114.2
006100P    05  C-TIME              PIC 9(8).                            SQ1114.2
006200P    05  C-NO-OF-TESTS       PIC 99.                              SQ1114.2
006300P    05  C-OK                PIC 999.                             SQ1114.2
006400P    05  C-ALL               PIC 999.                             SQ1114.2
006500P    05  C-FAIL              PIC 999.                             SQ1114.2
006600P    05  C-DELETED           PIC 999.                             SQ1114.2
006700P    05  C-INSPECT           PIC 999.                             SQ1114.2
006800P    05  C-NOTE              PIC X(13).                           SQ1114.2
006900P    05  C-INDENT            PIC X.                               SQ1114.2
007000P    05  C-ABORT             PIC X(8).                            SQ1114.2
007100 FD  PRINT-FILE                                                   SQ1114.2
007200C    LABEL RECORDS                                                SQ1114.2
007300C    XXXXX084                                                     SQ1114.2
007400C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1114.2
007500               .                                                  SQ1114.2
007600 01  PRINT-REC PICTURE X(120).                                    SQ1114.2
007700 01  DUMMY-RECORD PICTURE X(120).                                 SQ1114.2
007800 FD  SQ-FS1                                                       SQ1114.2
007900C    LABEL RECORD STANDARD                                        SQ1114.2
...
027500P    OPEN I-O RAW-DATA.                                           SQ1114.2
027600P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1114.2
027700P    READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ1114.2
027800P    MOVE "ABORTED " TO C-ABORT.                                  SQ1114.2
027900P    ADD 1 TO C-NO-OF-TESTS.                                      SQ1114.2
028000P    ACCEPT C-DATE  FROM DATE.                                    SQ1114.2
028100P    ACCEPT C-TIME  FROM TIME.                                    SQ1114.2
028200P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ1114.2
028300PEND-E-1.                                                         SQ1114.2
028400P    CLOSE RAW-DATA.                                              SQ1114.2
...
029900P    OPEN I-O RAW-DATA.                                           SQ1114.2
030000P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ1114.2
030100P    READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ1114.2
030200P    MOVE "OK.     " TO C-ABORT.                                  SQ1114.2
030300P    MOVE PASS-COUNTER TO C-OK.                                   SQ1114.2
030400P    MOVE ERROR-HOLD   TO C-ALL.                                  SQ1114.2
030500P    MOVE ERROR-COUNTER TO C-FAIL.                                SQ1114.2
030600P    MOVE DELETE-CNT TO C-DELETED.                                SQ1114.2
030700P    MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ1114.2
030800P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ1114.2
030900PEND-E-2.                                                         SQ1114.2
031000P    CLOSE RAW-DATA.                                              SQ1114.2
031100 TERMINATE-CCVS.                                                  SQ1114.2
031200S    EXIT PROGRAM.                                                SQ1114.2
031300STERMINATE-CALL.                                                  SQ1114.2
...
037500Y    IF RECORD-COUNT GREATER 50                                   SQ1114.2
037600Y        MOVE DUMMY-RECORD TO DUMMY-HOLD                          SQ1114.2
037700Y        MOVE SPACE TO DUMMY-RECORD                               SQ1114.2
037800Y        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  SQ1114.2
037900Y        MOVE CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN             SQ1114.2
038000Y        MOVE CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES     SQ1114.2
038100Y        MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN          SQ1114.2
038200Y        MOVE DUMMY-HOLD TO DUMMY-RECORD                          SQ1114.2
038300Y        MOVE ZERO TO RECORD-COUNT.                               SQ1114.2
