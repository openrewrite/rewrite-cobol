...
004700     XXXXX082.                                                    SQ1344.2
004800 OBJECT-COMPUTER.                                                 SQ1344.2
004900     XXXXX083.                                                    SQ1344.2
005000*                                                                 SQ1344.2
005100 INPUT-OUTPUT SECTION.                                            SQ1344.2
005200 FILE-CONTROL.                                                    SQ1344.2
005300     SELECT PRINT-FILE ASSIGN TO                                  SQ1344.2
005400     XXXXX055.                                                    SQ1344.2
005500*                                                                 SQ1344.2
005600P    SELECT RAW-DATA   ASSIGN TO                                  SQ1344.2
005700P    XXXXX062                                                     SQ1344.2
005800P          ORGANIZATION IS INDEXED                                SQ1344.2
005900P          ACCESS MODE  IS RANDOM                                 SQ1344.2
006000P          RECORD-KEY   IS RAW-DATA-KEY.                          SQ1344.2
006100P                                                                 SQ1344.2
...
007300C    LABEL RECORDS                                                SQ1344.2
007400C    XXXXX084                                                     SQ1344.2
007500C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1344.2
007600               .                                                  SQ1344.2
007700 01  PRINT-REC    PICTURE X(120).                                 SQ1344.2
007800 01  DUMMY-RECORD PICTURE X(120).                                 SQ1344.2
007900P                                                                 SQ1344.2
008000PFD  RAW-DATA.                                                    SQ1344.2
008100P01  RAW-DATA-SATZ.                                               SQ1344.2
008200P    05  RAW-DATA-KEY        PIC X(6).                            SQ1344.2
008300P    05  C-DATE              PIC 9(6).                            SQ1344.2
008400P    05  C-TIME              PIC 9(8).                            SQ1344.2
008500P    05  NO-OF-TESTS         PIC 99.                              SQ1344.2
008600P    05  C-OK                PIC 999.                             SQ1344.2
008700P    05  C-ALL               PIC 999.                             SQ1344.2
008800P    05  C-FAIL              PIC 999.                             SQ1344.2
008900P    05  C-DELETED           PIC 999.                             SQ1344.2
009000P    05  C-INSPECT           PIC 999.                             SQ1344.2
009100P    05  C-NOTE              PIC X(13).                           SQ1344.2
009200P    05  C-INDENT            PIC X.                               SQ1344.2
009300P    05  C-ABORT             PIC X(8).                            SQ1344.2
009400*                                                                 SQ1344.2
009500 FD  SQ-FS4                                                       SQ1344.2
009600C    LABEL RECORD IS STANDARD                                     SQ1344.2
...
046300Y    IF RECORD-COUNT GREATER 50                                   SQ1344.2
046400Y        MOVE    DUMMY-RECORD TO DUMMY-HOLD                       SQ1344.2
046500Y        MOVE    SPACE TO DUMMY-RECORD                            SQ1344.2
046600Y        WRITE   DUMMY-RECORD AFTER ADVANCING PAGE                SQ1344.2
046700Y        MOVE    CCVS-C-1 TO DUMMY-RECORD PERFORM DECL-WRT-LN     SQ1344.2
046800Y        MOVE    CCVS-C-2 TO DUMMY-RECORD                         SQ1344.2
046900Y        PERFORM DECL-WRT-LN 2 TIMES                              SQ1344.2
047000Y        MOVE    HYPHEN-LINE TO DUMMY-RECORD                      SQ1344.2
047100Y        PERFORM DECL-WRT-LN                                      SQ1344.2
047200Y        MOVE    DUMMY-HOLD TO DUMMY-RECORD                       SQ1344.2
047300Y        MOVE    ZERO TO RECORD-COUNT.                            SQ1344.2
...
051600P    OPEN    I-O RAW-DATA.                                        SQ1344.2
051700P    MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1344.2
051800P    READ    RAW-DATA INVALID KEY GO TO END-E-1.                  SQ1344.2
051900P    MOVE   "ABORTED "   TO C-ABORT.                              SQ1344.2
052000P    ADD     1           TO C-NO-OF-TESTS.                        SQ1344.2
052100P    ACCEPT  C-DATE      FROM DATE.                               SQ1344.2
052200P    ACCEPT  C-TIME      FROM TIME.                               SQ1344.2
052300P    REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1344.2
052400PEND-E-1.                                                         SQ1344.2
052500P    CLOSE   RAW-DATA.                                            SQ1344.2
...
054300P    OPEN    I-O RAW-DATA.                                        SQ1344.2
054400P    MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1344.2
054500P    READ    RAW-DATA INVALID KEY GO TO END-E-2.                  SQ1344.2
054600P    MOVE   "OK.     " TO C-ABORT.                                SQ1344.2
054700P    MOVE    PASS-COUNTER  TO C-OK.                               SQ1344.2
054800P    MOVE    ERROR-HOLD    TO C-ALL.                              SQ1344.2
054900P    MOVE    ERROR-COUNTER TO C-FAIL.                             SQ1344.2
055000P    MOVE    DELETE-CNT    TO C-DELETED.                          SQ1344.2
055100P    MOVE    INSPECT-COUNTER TO C-INSPECT.                        SQ1344.2
055200P    REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1344.2
055300PEND-E-2.                                                         SQ1344.2
055400P    CLOSE   RAW-DATA.                                            SQ1344.2
055500 TERMINATE-CCVS.                                                  SQ1344.2
055600S    EXIT    PROGRAM.                                             SQ1344.2
...
064800Y    IF RECORD-COUNT GREATER 50                                   SQ1344.2
064900Y        MOVE  DUMMY-RECORD TO DUMMY-HOLD                         SQ1344.2
065000Y        MOVE  SPACE TO DUMMY-RECORD                              SQ1344.2
065100Y        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  SQ1344.2
065200Y        MOVE  CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN            SQ1344.2
065300Y        MOVE  CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    SQ1344.2
065400Y        MOVE  HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN         SQ1344.2
065500Y        MOVE  DUMMY-HOLD TO DUMMY-RECORD                         SQ1344.2
065600Y        MOVE  ZERO TO RECORD-COUNT.                              SQ1344.2
