...
003700P    SELECT RAW-DATA   ASSIGN TO                                  SQ2224.2
003800P    XXXXX062                                                     SQ2224.2
003900P           ORGANIZATION IS INDEXED                               SQ2224.2
004000P           ACCESS MODE IS RANDOM                                 SQ2224.2
004100P           RECORD KEY IS RAW-DATA-KEY.                           SQ2224.2
...
005000P                                                                 SQ2224.2
005100PFD  RAW-DATA.                                                    SQ2224.2
005200P                                                                 SQ2224.2
005300P01  RAW-DATA-SATZ.                                               SQ2224.2
005400P    05  RAW-DATA-KEY        PIC X(6).                            SQ2224.2
005500P    05  C-DATE              PIC 9(6).                            SQ2224.2
005600P    05  C-TIME              PIC 9(8).                            SQ2224.2
005700P    05  C-NO-OF-TESTS       PIC 99.                              SQ2224.2
005800P    05  C-OK                PIC 999.                             SQ2224.2
005900P    05  C-ALL               PIC 999.                             SQ2224.2
006000P    05  C-FAIL              PIC 999.                             SQ2224.2
006100P    05  C-DELETED           PIC 999.                             SQ2224.2
006200P    05  C-INSPECT           PIC 999.                             SQ2224.2
006300P    05  C-NOTE              PIC X(13).                           SQ2224.2
006400P    05  C-INDENT            PIC X.                               SQ2224.2
006500P    05  C-ABORT             PIC X(8).                            SQ2224.2
006600 FD  PRINT-FILE                                                   SQ2224.2
006700C    LABEL RECORDS                                                SQ2224.2
006800C    XXXXX084                                                     SQ2224.2
006900C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2224.2
007000               .                                                  SQ2224.2
007100 01  PRINT-REC PICTURE X(120).                                    SQ2224.2
007200 01  DUMMY-RECORD PICTURE X(120).                                 SQ2224.2
007300 FD  SQ-VS7                                                       SQ2224.2
007400C    LABEL RECORDS ARE STANDARD                                   SQ2224.2
...
026900P    OPEN I-O RAW-DATA.                                           SQ2224.2
027000P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2224.2
027100P    READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2224.2
027200P    MOVE "ABORTED " TO C-ABORT.                                  SQ2224.2
027300P    ADD 1 TO C-NO-OF-TESTS.                                      SQ2224.2
027400P    ACCEPT C-DATE  FROM DATE.                                    SQ2224.2
027500P    ACCEPT C-TIME  FROM TIME.                                    SQ2224.2
027600P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2224.2
027700PEND-E-1.                                                         SQ2224.2
027800P    CLOSE RAW-DATA.                                              SQ2224.2
...
029300P    OPEN I-O RAW-DATA.                                           SQ2224.2
029400P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2224.2
029500P    READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2224.2
029600P    MOVE "OK.     " TO C-ABORT.                                  SQ2224.2
029700P    MOVE PASS-COUNTER TO C-OK.                                   SQ2224.2
029800P    MOVE ERROR-HOLD   TO C-ALL.                                  SQ2224.2
029900P    MOVE ERROR-COUNTER TO C-FAIL.                                SQ2224.2
030000P    MOVE DELETE-CNT TO C-DELETED.                                SQ2224.2
030100P    MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2224.2
030200P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2224.2
030300PEND-E-2.                                                         SQ2224.2
030400P    CLOSE RAW-DATA.                                              SQ2224.2
030500 TERMINATE-CCVS.                                                  SQ2224.2
030600S    EXIT PROGRAM.                                                SQ2224.2
030700STERMINATE-CALL.                                                  SQ2224.2
...
036900Y    IF RECORD-COUNT GREATER 50                                   SQ2224.2
037000Y        MOVE DUMMY-RECORD TO DUMMY-HOLD                          SQ2224.2
037100Y        MOVE SPACE TO DUMMY-RECORD                               SQ2224.2
037200Y        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  SQ2224.2
037300Y        MOVE CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN             SQ2224.2
037400Y        MOVE CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES     SQ2224.2
037500Y        MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN          SQ2224.2
037600Y        MOVE DUMMY-HOLD TO DUMMY-RECORD                          SQ2224.2
037700Y        MOVE ZERO TO RECORD-COUNT.                               SQ2224.2
