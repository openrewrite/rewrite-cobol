...
004700     XXXXX082.                                                    SQ1054.2
004800 OBJECT-COMPUTER.                                                 SQ1054.2
004900     XXXXX083.                                                    SQ1054.2
005000*                                                                 SQ1054.2
005100 INPUT-OUTPUT SECTION.                                            SQ1054.2
005200 FILE-CONTROL.                                                    SQ1054.2
005300     SELECT PRINT-FILE ASSIGN TO                                  SQ1054.2
005400     XXXXX055.                                                    SQ1054.2
005500*                                                                 SQ1054.2
005600P    SELECT RAW-DATA   ASSIGN TO                                  SQ1054.2
005700P    XXXXX062                                                     SQ1054.2
005800P          ORGANIZATION IS INDEXED                                SQ1054.2
005900P          ACCESS MODE  IS RANDOM                                 SQ1054.2
006000P          RECORD-KEY   IS RAW-DATA-KEY.                          SQ1054.2
006100P                                                                 SQ1054.2
...
007100C    XXXXX084                                                     SQ1054.2
007200C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1054.2
007300               .                                                  SQ1054.2
007400 01  PRINT-REC    PICTURE X(120).                                 SQ1054.2
007500 01  DUMMY-RECORD PICTURE X(120).                                 SQ1054.2
007600P                                                                 SQ1054.2
007700PFD  RAW-DATA.                                                    SQ1054.2
007800P01  RAW-DATA-SATZ.                                               SQ1054.2
007900P    05  RAW-DATA-KEY        PIC X(6).                            SQ1054.2
008000P    05  C-DATE              PIC 9(6).                            SQ1054.2
008100P    05  C-TIME              PIC 9(8).                            SQ1054.2
008200P    05  NO-OF-TESTS         PIC 99.                              SQ1054.2
008300P    05  C-OK                PIC 999.                             SQ1054.2
008400P    05  C-ALL               PIC 999.                             SQ1054.2
008500P    05  C-FAIL              PIC 999.                             SQ1054.2
008600P    05  C-DELETED           PIC 999.                             SQ1054.2
008700P    05  C-INSPECT           PIC 999.                             SQ1054.2
008800P    05  C-NOTE              PIC X(13).                           SQ1054.2
008900P    05  C-INDENT            PIC X.                               SQ1054.2
009000P    05  C-ABORT             PIC X(8).                            SQ1054.2
009100*                                                                 SQ1054.2
009200 FD  SQ-FS4                                                       SQ1054.2
009300     BLOCK CONTAINS 2 RECORDS                                     SQ1054.2
009400     RECORD 125                                                   SQ1054.2
009500C    LABEL RECORD STANDARD                                        SQ1054.2
...
035600P    OPEN    I-O RAW-DATA.                                        SQ1054.2
035700P    MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1054.2
035800P    READ    RAW-DATA INVALID KEY GO TO END-E-1.                  SQ1054.2
035900P    MOVE   "ABORTED "   TO C-ABORT.                              SQ1054.2
036000P    ADD     1           TO C-NO-OF-TESTS.                        SQ1054.2
036100P    ACCEPT  C-DATE      FROM DATE.                               SQ1054.2
036200P    ACCEPT  C-TIME      FROM TIME.                               SQ1054.2
036300P    REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1054.2
036400PEND-E-1.                                                         SQ1054.2
036500P    CLOSE   RAW-DATA.                                            SQ1054.2
...
038300P    OPEN    I-O RAW-DATA.                                        SQ1054.2
038400P    MOVE    CCVS-PGM-ID TO RAW-DATA-KEY.                         SQ1054.2
038500P    READ    RAW-DATA INVALID KEY GO TO END-E-2.                  SQ1054.2
038600P    MOVE   "OK.     " TO C-ABORT.                                SQ1054.2
038700P    MOVE    PASS-COUNTER  TO C-OK.                               SQ1054.2
038800P    MOVE    ERROR-HOLD    TO C-ALL.                              SQ1054.2
038900P    MOVE    ERROR-COUNTER TO C-FAIL.                             SQ1054.2
039000P    MOVE    DELETE-CNT    TO C-DELETED.                          SQ1054.2
039100P    MOVE    INSPECT-COUNTER TO C-INSPECT.                        SQ1054.2
039200P    REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1054.2
039300PEND-E-2.                                                         SQ1054.2
039400P    CLOSE   RAW-DATA.                                            SQ1054.2
039500 TERMINATE-CCVS.                                                  SQ1054.2
039600S    EXIT    PROGRAM.                                             SQ1054.2
...
048800Y    IF RECORD-COUNT GREATER 50                                   SQ1054.2
048900Y        MOVE  DUMMY-RECORD TO DUMMY-HOLD                         SQ1054.2
049000Y        MOVE  SPACE TO DUMMY-RECORD                              SQ1054.2
049100Y        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  SQ1054.2
049200Y        MOVE  CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN            SQ1054.2
049300Y        MOVE  CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    SQ1054.2
049400Y        MOVE  HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN         SQ1054.2
049500Y        MOVE  DUMMY-HOLD TO DUMMY-RECORD                         SQ1054.2
049600Y        MOVE  ZERO TO RECORD-COUNT.                              SQ1054.2
