...
005300C    LABEL RECORDS                                                SQ1554.2
005400C    XXXXX084                                                     SQ1554.2
005500C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1554.2
005600               .                                                  SQ1554.2
005700 01  PRINT-REC    PICTURE X(120).                                 SQ1554.2
005800 01  DUMMY-RECORD PICTURE X(120).                                 SQ1554.2
005900*                                                                 SQ1554.2
006000 FD  SQ-FS1                                                       SQ1554.2
006100C    LABEL RECORD IS STANDARD                                     SQ1554.2
006200                .                                                 SQ1554.2
...
012000           07 FILLER              PIC X(1).                       SQ1554.2
...
013000           07 XRECORD-KEY         PIC X(29).                      SQ1554.2
013100           07 FILLER              PIC X(9).                       SQ1554.2
013200           07 ALTERNATE-KEY1      PIC X(29).                      SQ1554.2
013300           07 FILLER              PIC X(9).                       SQ1554.2
013400           07 ALTERNATE-KEY2      PIC X(29).                      SQ1554.2
013500           07 FILLER              PIC X(7).                       SQ1554.2
013600*                                                                 SQ1554.2
013700 01  TEST-RESULTS.                                                SQ1554.2
...
014600       03 DOTVALUE            PIC 99     VALUE ZERO.              SQ1554.2
...
015200   02 COMPUTED-X.                                                 SQ1554.2
015300     03 COMPUTED-A    PIC X(20)  VALUE SPACE.                     SQ1554.2
015400     03 COMPUTED-N    REDEFINES COMPUTED-A PIC -9(9).9(9).        SQ1554.2
...
016600     03 CORRECT-A                  PIC X(20) VALUE SPACE.         SQ1554.2
...
017200         04 CORRECT-18V0                     PIC -9(18).          SQ1554.2
...
017700     02 FILLER  PIC IS X(4)     VALUE SPACE.                      SQ1554.2
...
018200 01  CCVS-C-2.                                                    SQ1554.2
018300     02 FILLER           PIC XXXX     VALUE SPACE.                SQ1554.2
...
019000 01  DELETE-COUNTER    PIC 999      VALUE ZERO.                   SQ1554.2
019100 01  ERROR-COUNTER     PIC 999      VALUE ZERO.                   SQ1554.2
...
021000            " COPY - NOT FOR DISTRIBUTION".                       SQ1554.2
021100   02  FILLER            PIC X(41)  VALUE SPACE.                  SQ1554.2
021200*                                                                 SQ1554.2
021300 01  CCVS-H-2B.                                                   SQ1554.2
021400   02  FILLER            PIC X(15)  VALUE "TEST RESULT OF ".      SQ1554.2
021500   02  TEST-ID           PIC X(9).                                SQ1554.2
021600   02  FILLER            PIC X(4)   VALUE " IN ".                 SQ1554.2
...
022200     "ON-SITE VALIDATION, NATIONAL INSTITUTE OF STD & TECH.     ".SQ1554.2
022300 01  CCVS-H-3.                                                    SQ1554.2
022400     02  FILLER          PIC X(34)  VALUE                         SQ1554.2
022500            " FOR OFFICIAL USE ONLY    ".                         SQ1554.2
022600     02  FILLER          PIC X(58)  VALUE                         SQ1554.2
...
023600     02  FILLER          PIC X(31)  VALUE SPACE.                  SQ1554.2
023700     02  FILLER          PIC X(21)  VALUE SPACE.                  SQ1554.2
023800     02  CCVS-E-2-2.                                              SQ1554.2
023900         03 ERROR-TOTAL    PIC XXX    VALUE SPACE.                SQ1554.2
024000         03 FILLER         PIC X      VALUE SPACE.                SQ1554.2
024100         03 ENDER-DESC     PIC X(44)  VALUE                       SQ1554.2
...
025200 01  CCVS-E-4.                                                    SQ1554.2
025300     02 CCVS-E-4-1       PIC XXX    VALUE SPACE.                  SQ1554.2
025400     02 FILLER           PIC X(4)   VALUE " OF ".                 SQ1554.2
...
025900     02 FILLER           PIC X(19)  VALUE "*** INFORMATION ***".  SQ1554.2
026000     02 INFO-TEXT.                                                SQ1554.2
...
038700Y    IF RECORD-COUNT GREATER 50                                   SQ1554.2
038800Y        MOVE  DUMMY-RECORD TO DUMMY-HOLD                         SQ1554.2
038900Y        MOVE  SPACE TO DUMMY-RECORD                              SQ1554.2
039000Y        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  SQ1554.2
039100Y        MOVE  CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN            SQ1554.2
039200Y        MOVE  CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES    SQ1554.2
039300Y        MOVE  HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN         SQ1554.2
039400Y        MOVE  DUMMY-HOLD TO DUMMY-RECORD                         SQ1554.2
039500Y        MOVE  ZERO TO RECORD-COUNT.                              SQ1554.2
