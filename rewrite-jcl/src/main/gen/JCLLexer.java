// Generated from /Users/yoshi/Development/Repos/openrewrite/rewrite-cobol/rewrite-jcl/src/main/antlr/JCLLexer.g4 by ANTLR 4.12.0
...
public class JCLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"UTF_8_BOM", "WS", "NEWLINE", "JCL_STATEMENT", "JECL_STATEMENT", "DELIMITER", 
			"LF", "CR", "CRLF", "FORM_FEED", "EOL", "COMMENT", "CNTL", "DATASET", 
			"DD", "ELSE", "ENDCNTL", "ENDDATASET", "ENDIF", "ENDPROCESS", "EXEC", 
			"EXPORT", "FORMAT", "IF", "INCLUDE", "JCLLIB", "JOB", "JOBPARM", "MAIN", 
			"MESSAGE", "NET", "NETACCT", "NOTIFY", "OPERATOR", "OUTPUT", "PAUSE", 
			"PEND", "PRIORITY", "PROC", "PROCESS", "ROUTE", "SCHEDULE", "SET", "SETUP", 
			"SIGNOFF", "SIGNON", "THEN", "XEQ", "XMIT", "PARAMETER", "PARAMETER_LITERAL", 
			...
			"PERIOD", "COMMA", "NAME_CHAR", "A", "B", "C", "D", "E", "F", "G", "H", 
