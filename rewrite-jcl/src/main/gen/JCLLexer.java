...
public class JCLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"UTF_8_BOM", "JCL_STATEMENT", "JES2_STATEMENT", "JES3_STATEMENT", "COMMENT_STATEMENT", 
			"WS", "NEWLINE", "LF", "CR", "CRLF", "FORM_FEED", "EOL", "COMMENT", "CNTL", 
			...
			"DOUBLEQUOTE", "NAME_FIELD", "PERIOD", "COMMA", "NAME_CHAR", "A", "B", 
