...
public class JCLLexer extends Lexer {
	...
	public static final int
		INSIDE_JES2=1, INSIDE_UNSUPPORTED=2;
	public static String[] channelNames = {
		"DEFAULT_TOKEN_CHANNEL", "HIDDEN"
	};

	public static String[] modeNames = {
		"DEFAULT_MODE", "INSIDE_JES2", "INSIDE_UNSUPPORTED"
	};

	private static String[] makeRuleNames() {
		return new String[] {
			"UTF_8_BOM", "WS", "NEWLINE", "CONTINUATION", "JCL_STATEMENT", "UNSUPPORTED", 
			"JES2", "LF", "CR", "CRLF", "FORM_FEED", "EOL", "CNTL", "DATASET", "DD", 
			"ELSE", "ENDCNTL", "ENDDATASET", "ENDIF", "ENDPROCESS", "EXEC", "EXPORT", 
			"FORMAT", "IF", "INCLUDE", "JCLLIB", "JOB", "JOBPARM", "MAIN", "MESSAGE", 
			"NET", "NETACCT", "NOTIFY", "OPERATOR", "OUTPUT", "PAUSE", "PEND", "PRIORITY", 
			...
			"PERIOD", "COMMA", "NAME_CHAR", "JES2_NEWLINE", "JES2_TEXT", "UNSUPPORTED_NEWLINE", 
			"UNSUPPORTED_TEXT", "A", "B", "C", "D", "E", "F", "G", "H", "I", "J", 
