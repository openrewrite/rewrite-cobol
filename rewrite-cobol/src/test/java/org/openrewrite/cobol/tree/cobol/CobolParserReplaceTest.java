...
public class CobolParserReplaceTest extends CobolTest {
    ...
    void sm201A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM201A.CBL"), sm201A, true)
        );
    }
    ...
    void sm202A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM202A.CBL"), sm202A, true)
        );
    }
    ...
    void sm203A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM203A.CBL"), sm203A, true)
        );
    }
    ...
    void sm205A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM205A.CBL"), sm205A, true)
        );
    }
    ...
    void sm206A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM206A.CBL"), sm206A, true)
        );
    }
    ...
    void sm208A() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM208A.CBL"), sm208A, true)
        );
    }

    @Test
    void sm201ATrailingSub() {
        rewriteRun(
          cobolPostProcess(getNistResource("SM201A_TRAILING_SUB.CBL"), sm201A, true)
        );
    }

    @Test
    void additiveReplace() {
        rewriteRun(
          cobolPostProcess(getNistResource("ADDITIVE_REPLACE.CBL"),
            """
    ...
    @Test
    void reductiveReplace() {
        rewriteRun(
          cobolPostProcess(getNistResource("REDUCTIVE_REPLACE.CBL"),
            """
              IDENTIFICATION DIVISION.
              PROGRAM-ID. SM208A.
              ENVIRONMENT DIVISION.
    ...
    private static final String sm201A =
            """
            IDENTIFICATION DIVISION.
            PROGRAM-ID.
                SM201A.
    ...
    private static final String sm202A =
            """
            IDENTIFICATION DIVISION.
            PROGRAM-ID.
                SM202A.
    ...
    private static final String sm203A =
            """
            IDENTIFICATION DIVISION.
            PROGRAM-ID.
                SM203A.
    ...
    private static final String sm205A =
            """
            IDENTIFICATION DIVISION.
            PROGRAM-ID.
                SM205A.
    ...
    private static final String sm206A =
            """
            IDENTIFICATION DIVISION.
            PROGRAM-ID.
                SM206A.
    ...
    private static final String sm208A =
            """
            IDENTIFICATION DIVISION.
            PROGRAM-ID. SM208A.
            ENVIRONMENT DIVISION.
