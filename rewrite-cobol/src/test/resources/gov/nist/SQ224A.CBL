...
003400P    SELECT RAW-DATA   ASSIGN TO                                  SQ2244.2
003500P    XXXXX062                                                     SQ2244.2
003600P           ORGANIZATION IS INDEXED                               SQ2244.2
003700P           ACCESS MODE IS RANDOM                                 SQ2244.2
003800P           RECORD KEY IS RAW-DATA-KEY.                           SQ2244.2
...
004700PFD  RAW-DATA.                                                    SQ2244.2
004800P                                                                 SQ2244.2
004900P01  RAW-DATA-SATZ.                                               SQ2244.2
005000P    05  RAW-DATA-KEY        PIC X(6).                            SQ2244.2
005100P    05  C-DATE              PIC 9(6).                            SQ2244.2
005200P    05  C-TIME              PIC 9(8).                            SQ2244.2
005300P    05  C-NO-OF-TESTS       PIC 99.                              SQ2244.2
005400P    05  C-OK                PIC 999.                             SQ2244.2
005500P    05  C-ALL               PIC 999.                             SQ2244.2
005600P    05  C-FAIL              PIC 999.                             SQ2244.2
005700P    05  C-DELETED           PIC 999.                             SQ2244.2
005800P    05  C-INSPECT           PIC 999.                             SQ2244.2
005900P    05  C-NOTE              PIC X(13).                           SQ2244.2
006000P    05  C-INDENT            PIC X.                               SQ2244.2
006100P    05  C-ABORT             PIC X(8).                            SQ2244.2
006200 FD  PRINT-FILE                                                   SQ2244.2
006300C    LABEL RECORDS                                                SQ2244.2
006400C    XXXXX084                                                     SQ2244.2
006500C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2244.2
006600               .                                                  SQ2244.2
006700 01  PRINT-REC PICTURE X(120).                                    SQ2244.2
006800 01  DUMMY-RECORD PICTURE X(120).                                 SQ2244.2
006900 FD  SQ-VS7                                                       SQ2244.2
007000C    LABEL RECORDS ARE STANDARD                                   SQ2244.2
...
027600P    OPEN I-O RAW-DATA.                                           SQ2244.2
027700P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2244.2
027800P    READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2244.2
027900P    MOVE "ABORTED " TO C-ABORT.                                  SQ2244.2
028000P    ADD 1 TO C-NO-OF-TESTS.                                      SQ2244.2
028100P    ACCEPT C-DATE  FROM DATE.                                    SQ2244.2
028200P    ACCEPT C-TIME  FROM TIME.                                    SQ2244.2
028300P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2244.2
028400PEND-E-1.                                                         SQ2244.2
028500P    CLOSE RAW-DATA.                                              SQ2244.2
...
029500P    OPEN I-O RAW-DATA.                                           SQ2244.2
029600P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2244.2
029700P    READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2244.2
029800P    MOVE "OK.     " TO C-ABORT.                                  SQ2244.2
029900P    MOVE PASS-COUNTER TO C-OK.                                   SQ2244.2
030000P    MOVE ERROR-HOLD   TO C-ALL.                                  SQ2244.2
030100P    MOVE ERROR-COUNTER TO C-FAIL.                                SQ2244.2
030200P    MOVE DELETE-CNT TO C-DELETED.                                SQ2244.2
030300P    MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2244.2
030400P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2244.2
030500PEND-E-2.                                                         SQ2244.2
030600P    CLOSE RAW-DATA.                                              SQ2244.2
030700 TERMINATE-CCVS.                                                  SQ2244.2
030800S    EXIT PROGRAM.                                                SQ2244.2
030900STERMINATE-CALL.                                                  SQ2244.2
...
037100Y    IF RECORD-COUNT GREATER 50                                   SQ2244.2
037200Y        MOVE DUMMY-RECORD TO DUMMY-HOLD                          SQ2244.2
037300Y        MOVE SPACE TO DUMMY-RECORD                               SQ2244.2
037400Y        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  SQ2244.2
037500Y        MOVE CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN             SQ2244.2
037600Y        MOVE CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES     SQ2244.2
037700Y        MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN          SQ2244.2
037800Y        MOVE DUMMY-HOLD TO DUMMY-RECORD                          SQ2244.2
037900Y        MOVE ZERO TO RECORD-COUNT.                               SQ2244.2
