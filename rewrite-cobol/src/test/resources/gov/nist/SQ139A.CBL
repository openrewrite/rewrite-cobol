000100 IDENTIFICATION DIVISION.                                         SQ1394.2
000200 PROGRAM-ID.                                                      SQ1394.2
000300     SQ139A.                                                      SQ1394.2
000400****************************************************************  SQ1394.2
000500*                                                              *  SQ1394.2
000600*    VALIDATION FOR:-                                          *  SQ1394.2
000700*    "ON-SITE VALIDATION, NATIONAL INSTITUTE OF STD & TECH.     ".SQ1394.2
000800*    USING CCVS85 VERSION 1.0 ISSUED IN JANUARY 1986.          *  SQ1394.2
000900*                             REVISED 1986, AUGUST             *  SQ1394.2
001000*                                                              *  SQ1394.2
001100*    CREATION DATE     /     VALIDATION DATE                   *  SQ1394.2
001200*    "COBOL 85 VERSION 4.2, Apr  1993 SSVG                      ".SQ1394.2
001300*                                                              *  SQ1394.2
001400****************************************************************  SQ1394.2
001500*                                                              *  SQ1394.2
001600*      X-CARDS USED BY THIS PROGRAM ARE :-                     *  SQ1394.2
001700*                                                              *  SQ1394.2
001800*            X-01   SEQUENTIAL MAGNETIC TAPE FILE.             *  SQ1394.2
001900*            X-55   SYSTEM PRINTER                             *  SQ1394.2
002000*            X-82   SOURCE-COMPUTER                            *  SQ1394.2
002100*            X-83   OBJECT-COMPUTER.                           *  SQ1394.2
002200*                                                              *  SQ1394.2
002300*                                                              *  SQ1394.2
002400****************************************************************  SQ1394.2
002500*                                                              *  SQ1394.2
002600*    SPLIT FROM SQ125A, THIS PROGRAM REPEATS THE SEQUENCE OF   *  SQ1394.2
002700*    FILE HANDLING ROUTINES IN ORDER TO CARRY OUT THE ISOLATED *  SQ1394.2
002800*    SPLIT TEST THAT CHECKS FOR THE CORRECT RESPONSE TO AN     *  SQ1394.2
002900*    OPEN FOR OUTPUT FOR A MAGNETIC TAPE FILE WHICH IS ALREADY *  SQ1394.2
003000*    OPEN IN THE OUTPUT MODE.  (SEE SQ125A).                   *  SQ1394.2
003100*                                                              *  SQ1394.2
003200****************************************************************  SQ1394.2
003300*                                                                 SQ1394.2
003400 ENVIRONMENT DIVISION.                                            SQ1394.2
...
004900P          ACCESS MODE  IS RANDOM                                 SQ1394.2
...
006100C    XXXXX084                                                     SQ1394.2
006200C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ1394.2
006300               .                                                  SQ1394.2
...
007100P    05  C-TIME              PIC 9(8).                            SQ1394.2
...
008900***************************************************************   SQ1394.2
009000*                                                             *   SQ1394.2
009100*    WORKING-STORAGE DATA ITEMS SPECIFIC TO THIS TEST SUITE   *   SQ1394.2
009200*                                                             *   SQ1394.2
009300***************************************************************   SQ1394.2
009400*                                                                 SQ1394.2
...
011400        05 FILLER                 PICTURE X(46)       VALUE       SQ1394.2
...
012400        05 FILLER                 PICTURE X(7)        VALUE SPACE.SQ1394.2
...
014000           07 XPROGRAM-NAME       PIC X(5).                       SQ1394.2
014100           07 FILLER              PIC X(7).                       SQ1394.2
014200           07 XRECORD-LENGTH      PIC 9(6).                       SQ1394.2
014300           07 FILLER              PIC X(7).                       SQ1394.2
014400           07 CHARS-OR-RECORDS    PIC X(2).                       SQ1394.2
014500           07 FILLER              PIC X(1).                       SQ1394.2
014600           07 XBLOCK-SIZE         PIC 9(4).                       SQ1394.2
014700           07 FILLER              PIC X(6).                       SQ1394.2
014800           07 RECORDS-IN-FILE     PIC 9(6).                       SQ1394.2
...
015500           07 XRECORD-KEY         PIC X(29).                      SQ1394.2
015600           07 FILLER              PIC X(9).                       SQ1394.2
...
016100*                                                                 SQ1394.2
016200 01  TEST-RESULTS.                                                SQ1394.2
016300     02 FILLER              PIC X      VALUE SPACE.               SQ1394.2
016400     02  PAR-NAME.                                                SQ1394.2
016500       03 FILLER              PIC X(14)  VALUE SPACE.             SQ1394.2
016600       03 PARDOT-X            PIC X      VALUE SPACE.             SQ1394.2
016700       03 DOTVALUE            PIC 99     VALUE ZERO.              SQ1394.2
016800     02 FILLER              PIC X      VALUE SPACE.               SQ1394.2
016900     02 FEATURE             PIC X(24)  VALUE SPACE.               SQ1394.2
017000     02 FILLER              PIC X      VALUE SPACE.               SQ1394.2
017100     02 P-OR-F              PIC X(5)   VALUE SPACE.               SQ1394.2
017200     02 FILLER              PIC X(9)   VALUE SPACE.               SQ1394.2
017300     02 RE-MARK             PIC X(61).                            SQ1394.2
017400 01  TEST-COMPUTED.                                               SQ1394.2
017500   02 FILLER  PIC X(30)  VALUE SPACE.                             SQ1394.2
017600   02 FILLER  PIC X(17)  VALUE "      COMPUTED =".                SQ1394.2
017700   02 COMPUTED-X.                                                 SQ1394.2
017800     03 COMPUTED-A    PIC X(20)  VALUE SPACE.                     SQ1394.2
...
018100     03 COMPUTED-4V14 REDEFINES COMPUTED-A PIC -9(4).9(14).       SQ1394.2
018200     03 COMPUTED-14V4 REDEFINES COMPUTED-A PIC -9(14).9(4).       SQ1394.2
018300     03       CM-18V0 REDEFINES COMPUTED-A.                       SQ1394.2
018400        04 COMPUTED-18V0                   PIC -9(18).            SQ1394.2
018500        04 FILLER                          PIC X.                 SQ1394.2
018600     03 FILLER PIC X(50) VALUE SPACE.                             SQ1394.2
018700 01  TEST-CORRECT.                                                SQ1394.2
018800     02 FILLER PIC X(30) VALUE SPACE.                             SQ1394.2
018900     02 FILLER PIC X(17) VALUE "       CORRECT =".                SQ1394.2
019000     02 CORRECT-X.                                                SQ1394.2
019100     03 CORRECT-A                  PIC X(20) VALUE SPACE.         SQ1394.2
019200     03 CORRECT-N    REDEFINES CORRECT-A     PIC -9(9).9(9).      SQ1394.2
019300     03 CORRECT-0V18 REDEFINES CORRECT-A     PIC -.9(18).         SQ1394.2
019400     03 CORRECT-4V14 REDEFINES CORRECT-A     PIC -9(4).9(14).     SQ1394.2
019500     03 CORRECT-14V4 REDEFINES CORRECT-A     PIC -9(14).9(4).     SQ1394.2
019600     03      CR-18V0 REDEFINES CORRECT-A.                         SQ1394.2
019700         04 CORRECT-18V0                     PIC -9(18).          SQ1394.2
019800         04 FILLER                           PIC X.               SQ1394.2
019900     03 FILLER PIC X(2) VALUE SPACE.                              SQ1394.2
020000     03 COR-ANSI-REFERENCE             PIC X(48) VALUE SPACE.     SQ1394.2
020100*                                                                 SQ1394.2
020200 01  CCVS-C-1.                                                    SQ1394.2
020300     02 FILLER  PIC IS X        VALUE  SPACE.                     SQ1394.2
020400     02 FILLER  PIC IS X(17)    VALUE "PARAGRAPH-NAME".           SQ1394.2
020500     02 FILLER  PIC IS X        VALUE  SPACE.                     SQ1394.2
020600     02 FILLER  PIC IS X(24)    VALUE IS "FEATURE".               SQ1394.2
020700     02 FILLER  PIC IS X        VALUE  SPACE.                     SQ1394.2
020800     02 FILLER  PIC IS X(5)     VALUE "PASS ".                    SQ1394.2
020900     02 FILLER  PIC IS X(9)     VALUE  SPACE.                     SQ1394.2
021000     02 FILLER  PIC IS X(62)    VALUE "REMARKS".                  SQ1394.2
021100 01  CCVS-C-2.                                                    SQ1394.2
021200     02 FILLER  PIC X(19)  VALUE  SPACE.                          SQ1394.2
021300     02 FILLER  PIC X(6)   VALUE "TESTED".                        SQ1394.2
021400     02 FILLER  PIC X(19)  VALUE  SPACE.                          SQ1394.2
021500     02 FILLER  PIC X(4)   VALUE "FAIL".                          SQ1394.2
021600     02 FILLER  PIC X(72)  VALUE  SPACE.                          SQ1394.2
021700*                                                                 SQ1394.2
...
022600 01  DUMMY-HOLD        PIC X(120)   VALUE SPACE.                  SQ1394.2
...
023500   02  FILLER            PIC X(40)  VALUE SPACE.                  SQ1394.2
...
024100   02  FILLER            PIC X(41)  VALUE SPACE.                  SQ1394.2
024200*                                                                 SQ1394.2
...
025200     "ON-SITE VALIDATION, NATIONAL INSTITUTE OF STD & TECH.     ".SQ1394.2
...
026100     02 FILLER           PIC X(52)  VALUE SPACE.                  SQ1394.2
...
026600     02  FILLER          PIC X(31)  VALUE SPACE.                  SQ1394.2
026700     02  FILLER          PIC X(21)  VALUE SPACE.                  SQ1394.2
026800     02  CCVS-E-2-2.                                              SQ1394.2
026900         03 ERROR-TOTAL    PIC XXX    VALUE SPACE.                SQ1394.2
027000         03 FILLER         PIC X      VALUE SPACE.                SQ1394.2
...
027600     02  FILLER          PIC X(12)  VALUE SPACE.                  SQ1394.2
027700     02  FILLER          PIC X(58)  VALUE                         SQ1394.2
027800     "ON-SITE VALIDATION, NATIONAL INSTITUTE OF STD & TECH.     ".SQ1394.2
027900     02  FILLER          PIC X(8)   VALUE SPACE.                  SQ1394.2
028000     02  FILLER          PIC X(20)  VALUE                         SQ1394.2
028100             " COPYRIGHT 1985,1986".                              SQ1394.2
028200 01  CCVS-E-4.                                                    SQ1394.2
028300     02 CCVS-E-4-1       PIC XXX    VALUE SPACE.                  SQ1394.2
028400     02 FILLER           PIC X(4)   VALUE " OF ".                 SQ1394.2
028500     02 CCVS-E-4-2       PIC XXX    VALUE SPACE.                  SQ1394.2
028600     02 FILLER           PIC X(40)  VALUE                         SQ1394.2
028700      "  TESTS WERE EXECUTED SUCCESSFULLY".                       SQ1394.2
028800 01  XXINFO.                                                      SQ1394.2
028900     02 FILLER           PIC X(19)  VALUE "*** INFORMATION ***".  SQ1394.2
029000     02 INFO-TEXT.                                                SQ1394.2
029100       04 FILLER             PIC X(8)   VALUE SPACE.              SQ1394.2
029200       04 XXCOMPUTED         PIC X(20).                           SQ1394.2
029300       04 FILLER             PIC X(5)   VALUE SPACE.              SQ1394.2
029400       04 XXCORRECT          PIC X(20).                           SQ1394.2
029500     02 INF-ANSI-REFERENCE PIC X(48).                             SQ1394.2
029600 01  HYPHEN-LINE.                                                 SQ1394.2
029700     02 FILLER  PIC IS X VALUE IS SPACE.                          SQ1394.2
029800     02 FILLER  PIC IS X(65)    VALUE IS "************************SQ1394.2
029900-    "*****************************************".                 SQ1394.2
...
030800 SQ139A-DECLARATIVE-001-SECT SECTION.                             SQ1394.2
...
031900     MOVE   "ABNORMAL TERMINATION AT THIS POINT IS ACCEPTABLE"    SQ1394.2
032000               TO DUMMY-RECORD                                    SQ1394.2
032100     PERFORM DECL-WRITE-LINE 3 TIMES.                             SQ1394.2
032200     GO TO   END-DECLS.                                           SQ1394.2
032300*                                                                 SQ1394.2
032400*                                                                 SQ1394.2
...
032900     MOVE   "UNEXPECTED ENTRY TO DECLARATIVES" TO RE-MARK.        SQ1394.2
...
034400*                                                                 SQ1394.2
034500 DECL-PRINT-DETAIL.                                               SQ1394.2
034600     IF REC-CT NOT EQUAL TO ZERO                                  SQ1394.2
034700             MOVE "." TO PARDOT-X                                 SQ1394.2
034800             MOVE REC-CT TO DOTVALUE.                             SQ1394.2
...
035300         PERFORM DECL-FAIL-ROUTINE THRU DECL-FAIL-EX              SQ1394.2
035400     ELSE                                                         SQ1394.2
035500         PERFORM DECL-BAIL THRU DECL-BAIL-EX.                     SQ1394.2
035600     MOVE    SPACE TO P-OR-F.                                     SQ1394.2
035700     MOVE    SPACE TO COMPUTED-X.                                 SQ1394.2
035800     MOVE    SPACE TO CORRECT-X.                                  SQ1394.2
035900     IF REC-CT EQUAL TO ZERO                                      SQ1394.2
...
036600Y        MOVE    DUMMY-RECORD TO DUMMY-HOLD                       SQ1394.2
036700Y        MOVE    SPACE TO DUMMY-RECORD                            SQ1394.2
036800Y        WRITE   DUMMY-RECORD AFTER ADVANCING PAGE                SQ1394.2
...
037400Y        MOVE    DUMMY-HOLD TO DUMMY-RECORD                       SQ1394.2
037500Y        MOVE    ZERO TO RECORD-COUNT.                            SQ1394.2
037600     PERFORM DECL-WRT-LN.                                         SQ1394.2
037700*                                                                 SQ1394.2
...
038300     IF COMPUTED-X NOT EQUAL TO SPACE GO TO DECL-FAIL-WRITE.      SQ1394.2
...
039000     GO TO   DECL-FAIL-EX.                                        SQ1394.2
039100 DECL-FAIL-WRITE.                                                 SQ1394.2
039200     MOVE    TEST-COMPUTED TO PRINT-REC                           SQ1394.2
...
039800 DECL-FAIL-EX.                                                    SQ1394.2
039900     EXIT.                                                        SQ1394.2
040000*                                                                 SQ1394.2
040100 DECL-BAIL.                                                       SQ1394.2
040200     IF COMPUTED-A NOT EQUAL TO SPACE GO TO DECL-BAIL-WRITE.      SQ1394.2
040300     IF CORRECT-A EQUAL TO SPACE GO TO DECL-BAIL-EX.              SQ1394.2
...
042300P    ADD     1           TO C-NO-OF-TESTS.                        SQ1394.2
042400P    ACCEPT  C-DATE      FROM DATE.                               SQ1394.2
042500P    ACCEPT  C-TIME      FROM TIME.                               SQ1394.2
...
043000     MOVE    CCVS-PGM-ID TO TEST-ID.                              SQ1394.2
043100     MOVE    CCVS-PGM-ID TO ID-AGAIN.                             SQ1394.2
043200     MOVE    SPACE TO TEST-RESULTS.                               SQ1394.2
...
043600     GO TO CCVS1-EXIT.                                            SQ1394.2
043700*                                                                 SQ1394.2
...
045100P    MOVE    ERROR-HOLD    TO C-ALL.                              SQ1394.2
045200P    MOVE    ERROR-COUNTER TO C-FAIL.                             SQ1394.2
045300P    MOVE    DELETE-CNT    TO C-DELETED.                          SQ1394.2
045400P    MOVE    INSPECT-COUNTER TO C-INSPECT.                        SQ1394.2
045500P    REWRITE RAW-DATA-SATZ INVALID KEY CONTINUE.                  SQ1394.2
045600PEND-E-2.                                                         SQ1394.2
045700P    CLOSE   RAW-DATA.                                            SQ1394.2
045800 TERMINATE-CCVS.                                                  SQ1394.2
...
048100     PERFORM PRINT-DETAIL.                                        SQ1394.2
048200*                                                                 SQ1394.2
048300 PRINT-DETAIL.                                                    SQ1394.2
048400     IF REC-CT NOT EQUAL TO ZERO                                  SQ1394.2
...
049100         PERFORM FAIL-ROUTINE THRU FAIL-ROUTINE-EX                SQ1394.2
049200     ELSE                                                         SQ1394.2
049300         PERFORM BAIL-OUT THRU BAIL-OUT-EX.                       SQ1394.2
049400     MOVE    SPACE TO P-OR-F.                                     SQ1394.2
049500     MOVE    SPACE TO COMPUTED-X.                                 SQ1394.2
049600     MOVE    SPACE TO CORRECT-X.                                  SQ1394.2
049700     IF REC-CT EQUAL TO ZERO  MOVE SPACE TO PAR-NAME.             SQ1394.2
049800     MOVE    SPACE TO RE-MARK.                                    SQ1394.2
049900*                                                                 SQ1394.2
...
050300     MOVE CCVS-H-2B TO DUMMY-RECORD. PERFORM WRITE-LINE 3 TIMES.  SQ1394.2
050400     MOVE CCVS-H-3  TO DUMMY-RECORD. PERFORM WRITE-LINE 3 TIMES.  SQ1394.2
...
051700     ADD     ERROR-COUNTER   TO ERROR-HOLD                        SQ1394.2
...
052300     MOVE    CCVS-E-4        TO CCVS-E-2-2.                       SQ1394.2
052400     MOVE    CCVS-E-2        TO DUMMY-RECORD                      SQ1394.2
052500     PERFORM WRITE-LINE.                                          SQ1394.2
052600     MOVE   "TEST(S) FAILED" TO ENDER-DESC.                       SQ1394.2
052700     IF ERROR-COUNTER IS EQUAL TO ZERO                            SQ1394.2
...
055200Y        MOVE  DUMMY-RECORD TO DUMMY-HOLD                         SQ1394.2
...
055700Y        MOVE  HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN         SQ1394.2
055800Y        MOVE  DUMMY-HOLD TO DUMMY-RECORD                         SQ1394.2
055900Y        MOVE  ZERO TO RECORD-COUNT.                              SQ1394.2
056000     PERFORM WRT-LN.                                              SQ1394.2
056100*                                                                 SQ1394.2
056200 WRT-LN.                                                          SQ1394.2
056300     WRITE   DUMMY-RECORD AFTER ADVANCING 1 LINES.                SQ1394.2
056400     MOVE    SPACE TO DUMMY-RECORD.                               SQ1394.2
056500 BLANK-LINE-PRINT.                                                SQ1394.2
056600     PERFORM WRT-LN.                                              SQ1394.2
056700 FAIL-ROUTINE.                                                    SQ1394.2
056800     IF COMPUTED-X NOT EQUAL TO SPACE GO TO FAIL-ROUTINE-WRITE.   SQ1394.2
...
057100     MOVE   "NO FURTHER INFORMATION, SEE PROGRAM." TO INFO-TEXT.  SQ1394.2
...
057500     GO TO   FAIL-ROUTINE-EX.                                     SQ1394.2
057600 FAIL-ROUTINE-WRITE.                                              SQ1394.2
057700     MOVE    TEST-COMPUTED  TO PRINT-REC                          SQ1394.2
...
058300 FAIL-ROUTINE-EX.                                                 SQ1394.2
058400     EXIT.                                                        SQ1394.2
058500 BAIL-OUT.                                                        SQ1394.2
058600     IF COMPUTED-A NOT EQUAL TO SPACE GO TO BAIL-OUT-WRITE.       SQ1394.2
058700     IF CORRECT-A EQUAL TO SPACE GO TO BAIL-OUT-EX.               SQ1394.2
...
060300*    THE START OF THE TESTS OF SPECIFIC COBOL FEATURES.        *  SQ1394.2
060400*                                                              *  SQ1394.2
060500****************************************************************  SQ1394.2
060600*                                                                 SQ1394.2
...
061100*                                                                 SQ1394.2
061200 SEQ-INIT-01.                                                     SQ1394.2
061300*                                                                 SQ1394.2
061400     MOVE    1 TO REC-CT                                          SQ1394.2
061500     MOVE   "CREATE FILE, OPEN OUTPUT" TO FEATURE                 SQ1394.2
