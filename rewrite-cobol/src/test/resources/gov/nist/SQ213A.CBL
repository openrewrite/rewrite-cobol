...
003100P    SELECT RAW-DATA   ASSIGN TO                                  SQ2134.2
003200P    XXXXX062                                                     SQ2134.2
003300P           ORGANIZATION IS INDEXED                               SQ2134.2
003400P           ACCESS MODE IS RANDOM                                 SQ2134.2
003500P           RECORD KEY IS RAW-DATA-KEY.                           SQ2134.2
...
004800P                                                                 SQ2134.2
004900PFD  RAW-DATA.                                                    SQ2134.2
005000P                                                                 SQ2134.2
005100P01  RAW-DATA-SATZ.                                               SQ2134.2
005200P    05  RAW-DATA-KEY        PIC X(6).                            SQ2134.2
005300P    05  C-DATE              PIC 9(6).                            SQ2134.2
005400P    05  C-TIME              PIC 9(8).                            SQ2134.2
005500P    05  C-NO-OF-TESTS       PIC 99.                              SQ2134.2
005600P    05  C-OK                PIC 999.                             SQ2134.2
005700P    05  C-ALL               PIC 999.                             SQ2134.2
005800P    05  C-FAIL              PIC 999.                             SQ2134.2
005900P    05  C-DELETED           PIC 999.                             SQ2134.2
006000P    05  C-INSPECT           PIC 999.                             SQ2134.2
006100P    05  C-NOTE              PIC X(13).                           SQ2134.2
006200P    05  C-INDENT            PIC X.                               SQ2134.2
006300P    05  C-ABORT             PIC X(8).                            SQ2134.2
006400 FD  PRINT-FILE                                                   SQ2134.2
006500C    LABEL RECORDS                                                SQ2134.2
006600C    XXXXX084                                                     SQ2134.2
006700C    DATA RECORD IS PRINT-REC DUMMY-RECORD                        SQ2134.2
006800               .                                                  SQ2134.2
006900 01  PRINT-REC PICTURE X(120).                                    SQ2134.2
007000 01  DUMMY-RECORD PICTURE X(120).                                 SQ2134.2
007100 FD  SQ-FS1                                                       SQ2134.2
007200C    LABEL RECORDS ARE STANDARD                                   SQ2134.2
...
007900C    LABEL RECORDS ARE STANDARD                                   SQ2134.2
...
027700P    OPEN I-O RAW-DATA.                                           SQ2134.2
027800P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2134.2
027900P    READ RAW-DATA INVALID KEY GO TO END-E-1.                     SQ2134.2
028000P    MOVE "ABORTED " TO C-ABORT.                                  SQ2134.2
028100P    ADD 1 TO C-NO-OF-TESTS.                                      SQ2134.2
028200P    ACCEPT C-DATE  FROM DATE.                                    SQ2134.2
028300P    ACCEPT C-TIME  FROM TIME.                                    SQ2134.2
028400P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-1.             SQ2134.2
028500PEND-E-1.                                                         SQ2134.2
028600P    CLOSE RAW-DATA.                                              SQ2134.2
...
030100P    OPEN I-O RAW-DATA.                                           SQ2134.2
030200P    MOVE CCVS-PGM-ID TO RAW-DATA-KEY.                            SQ2134.2
030300P    READ RAW-DATA INVALID KEY GO TO END-E-2.                     SQ2134.2
030400P    MOVE "OK.     " TO C-ABORT.                                  SQ2134.2
030500P    MOVE PASS-COUNTER TO C-OK.                                   SQ2134.2
030600P    MOVE ERROR-HOLD   TO C-ALL.                                  SQ2134.2
030700P    MOVE ERROR-COUNTER TO C-FAIL.                                SQ2134.2
030800P    MOVE DELETE-CNT TO C-DELETED.                                SQ2134.2
030900P    MOVE INSPECT-COUNTER TO C-INSPECT.                           SQ2134.2
031000P    REWRITE RAW-DATA-SATZ INVALID KEY GO TO END-E-2.             SQ2134.2
031100PEND-E-2.                                                         SQ2134.2
031200P    CLOSE RAW-DATA.                                              SQ2134.2
031300 TERMINATE-CCVS.                                                  SQ2134.2
031400S    EXIT PROGRAM.                                                SQ2134.2
031500STERMINATE-CALL.                                                  SQ2134.2
...
037700Y    IF RECORD-COUNT GREATER 50                                   SQ2134.2
037800Y        MOVE DUMMY-RECORD TO DUMMY-HOLD                          SQ2134.2
037900Y        MOVE SPACE TO DUMMY-RECORD                               SQ2134.2
038000Y        WRITE DUMMY-RECORD AFTER ADVANCING PAGE                  SQ2134.2
038100Y        MOVE CCVS-C-1 TO DUMMY-RECORD PERFORM WRT-LN             SQ2134.2
038200Y        MOVE CCVS-C-2 TO DUMMY-RECORD PERFORM WRT-LN 2 TIMES     SQ2134.2
038300Y        MOVE HYPHEN-LINE TO DUMMY-RECORD PERFORM WRT-LN          SQ2134.2
038400Y        MOVE DUMMY-HOLD TO DUMMY-RECORD                          SQ2134.2
038500Y        MOVE ZERO TO RECORD-COUNT.                               SQ2134.2
